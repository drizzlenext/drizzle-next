...
:::warning
Note: The following code examples are not specific to any library. Just something I made up to help illustrate the concepts. If you're looking for the Drizzle ORM docs, you can find it at their [website](https://orm.drizzle.team).
:::
...
Drizzle ORM met all of my criteria. Of course, there are other cool things like performance, good DX (Developer Experience), and having the flexibility to execute raw sql, build queries, and use an ORM. But my main requirements were met.
